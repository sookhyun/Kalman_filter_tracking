...
class CellularAutomaton : public PHObject {
 ...
 public:
  ...
  virtual void set_layer_begin(unsigned int lbegin) {}
  virtual void set_layer_end(unsigned int lend) {}
  ...
  virtual void set_ca_zproj_phi_cut(float phi_cut) {}
  virtual void set_ca_zproj_z_cut(float z_cut) {}
  virtual void set_ca_pproj_phi_cut(float phi_cut) {}
  virtual void set_ca_pproj_z_cut(float z_cut) {}
 ...
 private:
  ...
  virtual void sort_clusters_by_layer() {}
  
  virtual int init() {return 0;}
  virtual int process_tracks() {return 0;}
  virtual int process_single_houghbin(Track3D& track) {return 0;}
  virtual int process_single_tracklet(Track3D& track) {return 0;}
  virtual int extend_single_triplet(Track3D& track) {return 0;}
