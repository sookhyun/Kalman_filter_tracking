...
float HelixKalmanFilter::getZProjection(Cluster3D& hit, HelixTrackState& state){
...
float HelixKalmanFilter::getPhiProjection(Cluster3D& hit, HelixTrackState& state){
